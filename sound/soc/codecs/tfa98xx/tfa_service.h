...
/* #include "config.h" */
/* workaround for Visual Studio:*/ /* fatal error C1083: Cannot open include file: 'config.h': No such file or directory */
#ifdef __KERNEL__
...
/**
 * patch the ROM code of the DSP * @param handle to opened instance
...
/** * read the current status of the DSP, typically used for development, * not essential to be used in a product
 */
